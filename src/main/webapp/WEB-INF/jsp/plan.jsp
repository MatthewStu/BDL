...
<body>
		...
		<div class="container">
			<div class="row text-center fh5co-heading row-padded">
				<div class="col-md-8 col-md-offset-2">
					<h2 class="heading to-animate">Plan Your Workout</h2>
					<p class="sub-heading to-animate">Here is where you build your workout.</p>
				</div>
			</div>
			...
			<div class="">
				...
				<div class="fh5co-food-menu to-animate-2">
					<h2 class="fh5co-drinks">Plan List</h2>
					<ul>
					<form:form modelAttribute="userPlan" action="/testW" method="POST">
						<c:forEach items="${plans}" var="plan" varStatus="loop">
							<li>
								<div class="fh5co-food-desc">
									<figure> <img src="${plan.planImg}"
										class="img-responsive"
										alt="Free HTML5 Templates by FREEHTML5.co"> </figure>
									<div>
										<h3>${plan.planName}</h3>
										<p>${plan.planDesc}</p>
										<input type="checkbox" value="${plan.planId}"
											onclick="displayPlan(this)">
									</div>
									
									<c:forEach items="${plan.workouts}" var="workout">
										<div class="plan${workout.planId}  testId">
											<ul>
												<li>
													<div class="fh5co-food-desc" style="">

														<div>
															<a href="${workout.workoutVideo2}"><h3>${workout.workoutName}</h3></a>
															<p>${workout.workoutDescription}</p>
															<form:checkbox path="workoutName" value="${workout.workoutName}"/>
														</div>
													</div>
												</li>
											</ul>
	...
	(function() {
		...
		var x = document.getElementsByClassName('testId');
		//alert(x.length);
		var i;
	...
	function displayPlan(obj)
	{
		var id = $(obj).attr('value')
		var x = document.getElementsByClassName('plan'+id);
		var i;
		for(i =0; i < x.length; i++)
		{
